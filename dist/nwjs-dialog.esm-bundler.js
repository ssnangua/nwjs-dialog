...
function messageBox(win, options) {
    return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
        ...
        nw.Window.open(preset.htmlPath + `?t=${Date.now()}`, Object.assign({ id, frame: false, show: false, position: "center", icon: winIcon }, {
...
export { showMessageBox, showOpenDialog, showSaveDialog };
